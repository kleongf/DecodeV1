...
@Autonomous(name="BLUE COMP EXTRA GATE 21", group="a comp")
public class BlueExtraGate21 extends OpMode {
    ...
    private PathChain intakeSecond, shootSecond, intakeGate1, shootGate1, intakeGate2, shootGate2, intakeGate3, shootGate3, intakeGate4, shootGate4, intakeThird, shootThird, intakeFirst, shootFirst;
    public void buildPaths() {
        intakeSecond = follower.pathBuilder()
                .addPath(
                        new BezierLine(PoseConstants.BLUE_CLOSE_AUTO_POSE, new Pose(38.000, 115.000))
                )
                .setLinearHeadingInterpolation(PoseConstants.BLUE_CLOSE_AUTO_POSE.getHeading(), Math.toRadians(180))
                .addPath(
                        new BezierLine(new Pose(38.000, 115.000), new Pose(54.000, 90.000))
                )
