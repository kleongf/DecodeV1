...
public class PurePursuitConstants {
    ...
    public static PIDFCoefficients LONGITUDINAL_COEFFICIENTS = new PIDFCoefficients(0.12, 0, 0.0012, 0); // both were 0.1p earlier
    public static PIDFCoefficients LATERAL_COEFFICIENTS = new PIDFCoefficients(0.06, 0, 0.0006, 0);
