...
@Autonomous(name="RED COMP PILE", group="a comp")
public class RedAutoPileComp extends OpMode {
    ...
    public void buildPaths() {
        ...
        intakeSecond = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(144-60.000, 59.000),
                                new Pose(144-55.000, 59.000),
        ...
        openGate1 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(144-32.362, 59.936),
                                new Pose(144-32.362, 73.340),
                                new Pose(144-13.000, 73.000)
                        )
                )
        ...
        shootSecond = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(180-270), Math.toRadians(180-250))
                .build();
        intakePile1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(PoseConstants.RED_SHOOT_AUTO_POSE, new Pose(144-10, 16))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180-250))
                .build();

        shootPile1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-10, 16), PoseConstants.RED_SHOOT_AUTO_POSE)
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-250), Math.toRadians(180-180))
                .build();
        ...
        intakePile2 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-60, 84), new Pose(144-10, 16))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180-250))
                .build();
        ...
        shootPile2 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-10, 16), new Pose(144-46.000, 10.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-250), Math.toRadians(180-180))
                .build();
        ...
        intakePile3 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-46.000, 10.000), new Pose(144-8, 14))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180-180))
                .build();
        ...
        shootPile3 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-8, 14), new Pose(144-46.000, 10.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180-180))
                .build();
    }
        ...
        stateMachine = new StateMachine(
                ...
                new State()
                        .onEnter(() -> {
                            ...
                            shootPose = new Pose(144-54, 78, Math.toRadians(180-250));
                        })
                        .maxTime(2000),
                new State()
                        .onEnter(() -> {
                ...
                new State()
                        .onEnter(() -> {
                            shootPose = new Pose(144-46, 10, Math.toRadians(180-180));
