...
@Autonomous(name="RED COMP LEGAL 21", group="?")
public class RedCompLegal21 extends OpMode {
    private VoltageCompFollower follower;
    private StateMachine stateMachine;
    private AutonomousRobot robot;
    private SOTM sotm2;
    private final Pose startPose = PoseConstants.RED_FAR_AUTO_POSE;
    private Pose shootPose = new Pose(144-50, 12, Math.toRadians(180-180));
    ...
    public void buildPaths() {
        shootPreload = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(144-55.000, 6.000),
                                new Pose(144-50.000, 12.000)
                        )
                )
                .setLinearHeadingInterpolation(startPose.getHeading(), Math.toRadians(180-180))
        ...
        intakeSecond = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(144-50.000, 12.000),
                                new Pose(144-46.700, 60.000),
                                new Pose(144-13.000, 60.000)
                        )
        ...
        openGate = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(144-13.000, 60.000),
                                new Pose(144-30.713, 72.723),
                                new Pose(144-14.000, 73.000)
                        )
                            ...
                            intakePile1 = follower.pathBuilder()
                                    .addPath(
                                            new BezierCurve(
                                                    ...
                                                    new Pose(144-10, MathUtil.clamp(currentY+optimalX, 9, 40))
                                            )
                                    )
                                    .setConstantHeadingInterpolation(Math.toRadians(180-180))
                                    .setPathEndVelocityConstraint(20)
                                    .setPathEndTValueConstraint(0.9)
                                    .setPathEndHeadingConstraint(Math.toRadians(180-5))
                                    .setZeroPowerAccelerationMultiplier(3)
                                    .build();
