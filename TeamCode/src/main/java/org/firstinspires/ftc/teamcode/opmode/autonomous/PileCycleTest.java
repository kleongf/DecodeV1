...
@Autonomous(name="pile cycle test blue 24", group="not a comp")
public class PileCycleTest extends OpMode {
    ...
    private Pose shootPose = new Pose(62, 24, Math.toRadians(180)); // i dont care but 62, 24, 180 deg
    private final Pose goalPose = PoseConstants.BLUE_GOAL_POSE;
    private PathChain scorePreload, intakeCorner, shootCorner, intakeThird, shootThird, intakePile1, shootPile1, intakePile2, shootPile2, intakePile3, shootPile3, intakePile4, shootPile4, intakePile5, shootPile5;
