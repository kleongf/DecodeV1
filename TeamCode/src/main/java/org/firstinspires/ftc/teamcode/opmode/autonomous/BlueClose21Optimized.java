...
@Autonomous(name="BLUE 21 testing tangential", group="not a comp")
public class BlueClose21Optimized extends OpMode {
        ...
        stateMachine = new StateMachine(
                ...
                new State()
                        .onEnter(() -> {
                            ...
                            follower.setSecondaryTranslationalPIDF(new CustomPIDFCoefficients(0.15,0,0.0075,0.0));
