...
@Autonomous(name="RED CLOSE 21 FINAL", group="not a comp")
public class RedClose21Final extends OpMode {
    ...
    private Pose shootPose =
            new Pose(144 - 54, 90, Math.toRadians(180 - (-110)));
    ...
    private PathChain shootPreload, intakeSecond, shootSecond,
            ...
            intakeGate3, shootGate3, intakeThird, shootThird,
        ...
        stateMachine = new StateMachine(
                ...
                new State()
                        .onEnter(() -> {
                            ...
                            shootPose = new Pose(144-54, 115, Math.toRadians(180-(-118))); // Math.toRadians(180)+Math.atan2(104-36, 58-12)
