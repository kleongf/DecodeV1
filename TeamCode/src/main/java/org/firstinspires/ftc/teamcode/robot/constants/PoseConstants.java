...
public class PoseConstants {
    ...
    // 14.2 60.4, 147
    public static Pose BLUE_GATE_AUTO_POSE =  new Pose(10.75, 62.2, Math.toRadians(150));
    public static Pose RED_GATE_AUTO_POSE = new Pose(144-10.75, 62.2, Math.toRadians(180-150));
