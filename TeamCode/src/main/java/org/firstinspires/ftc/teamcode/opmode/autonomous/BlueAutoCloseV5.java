...
@Autonomous(name="21 AURA CLOSE SOTM optimized and leave", group="comp")
...
//                        .transition(new Transition(() -> robot.prepareShooting.isFinished())),
                ...
                new State()
                        .onEnter(() -> {
                            robot.prepareIntake.start();
                            shootPose = new Pose(58, 104, Math.toRadians(240)); // Math.toRadians(180)+Math.atan2(104-36, 58-12)
